...
char_race
ggplot(char_race, aes(x=CHARACTER_RACE, y=char_race_perc, fill = CHARACTER_RACE)) + geom_col() +ggtitle('Actor Representation by Character Race') + ylab('Character Race Proportion (%)')  + scale_fill_manual(values=c('#e41a1c', '#377eb8', '#4daf4a', '#984ea3', '#ff7f00',  '#ffff33', '#f781bf'))
...
actor_race
ggplot(actor_race, aes(x= ACTOR_RACE, y= actor_race_perc, fill = ACTOR_RACE)) + geom_col() +ggtitle('Actor Representation by Actor Race') + ylab('Character Race Proportion (%)') + scale_fill_manual(values=c('#e41a1c', '#377eb8', '#4daf4a', '#984ea3', '#ff7f00',  '#ffff33', '#f781bf'))
